...
("S4"
 ...
 (position . 292))
("mesdocuments"
 (filename . "~/mesdocuments/")
 (front-context-string . "personnel\n  drwx")
 (rear-context-string . " mars   2 13:41 ")
 (position . 269))
...
("GTD.org"
 ...
 (position . 1))
("Inbox.org"
 (filename . "~/sharedDirectoryPrivate/notes/org/orgzly/Inbox.org")
 (front-context-string)
 (rear-context-string . " zettelkasten ?\n")
 (position . 8759))
("orgzly"
 (filename . "~/sharedDirectoryPrivate/notes/org/orgzly/")
 (front-context-string . "AgendaTickler.or")
 (rear-context-string . " févr. 28 07:17 ")
 (position . 238))
("ancienneconfigorg"
 (filename . "~/.emacs.dAutreOrdi/config.org")
 (front-context-string . "\"~/.emacs.d/var/")
 (rear-context-string . "q savehist-file ")
 (position . 12234)
 (annotation . "c'est un test d'annotation"))
)
